# FILE_MAP_BEGIN {"file_metadata":{"type":"python","language":"python","title":"gpt5_vs_gpt41_comprehensive_test_framework_bkp.py","description":"Python module with 1 functions and 6 classes","last_updated":"2025-08-07"},"code_elements":{"functions":[{"name":"main","line":2553,"parameters":[],"is_async":true,"description":"The entry point of the application, executed asynchronously to manage the main workflow.","signature":"async main()"}],"classes":[{"name":"TestCategory","line":34,"inherits_from":["Enum):"],"methods":[],"properties":[{"name":"CODE_GENERATION","line":33,"type":""},{"name":"REASONING","line":34,"type":""},{"name":"CREATIVE_TASKS","line":35,"type":""},{"name":"STRUCTURED_OUTPUT","line":36,"type":""},{"name":"AGENTIC_TASKS","line":37,"type":""},{"name":"LONG_CONTEXT","line":38,"type":""},{"name":"FACTUALITY","line":39,"type":""},{"name":"CODING_REASONING","line":40,"type":""},{"name":"ALGORITHM_DESIGN","line":41,"type":""},{"name":"CODE_OPTIMIZATION","line":42,"type":""}],"description":"Represents a category of tests, used for organizing and managing test cases."},{"name":"ModelTier","line":46,"inherits_from":["Enum):"],"methods":[],"properties":[{"name":"NANO","line":45,"type":""},{"name":"MINI","line":46,"type":""},{"name":"STANDARD","line":47,"type":""}],"description":"Defines different tiers or levels of models, potentially indicating their complexity or performance."},{"name":"ReasoningEffort","line":51,"inherits_from":["Enum):"],"methods":[],"properties":[{"name":"LOW","line":50,"type":""},{"name":"MEDIUM","line":51,"type":""},{"name":"HIGH","line":52,"type":""}],"description":"Encapsulates the effort or resources required for reasoning tasks within the evaluation framework."},{"name":"EvaluationMetrics","line":1616,"inherits_from":[],"methods":[],"properties":[],"description":"Holds various metrics used to evaluate model performance and effectiveness."},{"name":"ModelEvaluator","line":1629,"inherits_from":[],"methods":[{"name":"__init__","line":1632,"parameters":[{"name":"self","type":"self"}],"is_async":false,"signature":"__init__(self)"},{"name":"evaluate_model","line":1636,"parameters":[{"name":"self","type":"self"},{"name":"model","type":"str, category: TestCategory, test_name: str, prompt: str, dataset: Dict"},{"name":"category","type":"TestCategory, test_name: str, prompt: str, dataset: Dict"},{"name":"test_name","type":"str, prompt: str, dataset: Dict"},{"name":"prompt","type":"str, dataset: Dict"},{"name":"dataset","type":"Dict"}],"is_async":true,"return_type":"EvaluationMetrics","description":"Evaluate a single model on a specific test.","signature":"async evaluate_model(self, model: str, category: TestCategory, test_name: str, prompt: str, dataset: Dict, category: TestCategory, test_name: str, prompt: str, dataset: Dict, test_name: str, prompt: str, dataset: Dict, prompt: str, dataset: Dict, dataset: Dict) -> EvaluationMetrics"},{"name":"evaluate_model_with_reasoning_effort","line":1685,"parameters":[{"name":"self","type":"self"},{"name":"model","type":"unknown"},{"name":"category","type":"TestCategory, test_name: str, prompt: str, dataset: Dict, effort_level: ReasoningEffort"},{"name":"test_name","type":"str, prompt: str, dataset: Dict, effort_level: ReasoningEffort"},{"name":"prompt","type":"str, dataset: Dict, effort_level: ReasoningEffort"},{"name":"dataset","type":"Dict, effort_level: ReasoningEffort"},{"name":"effort_level","type":"ReasoningEffort"}],"is_async":true,"return_type":"EvaluationMetrics","description":"Evaluate a GPT-5 model with specific reasoning effort level.","signature":"async evaluate_model_with_reasoning_effort(self, model, category: TestCategory, test_name: str, prompt: str, dataset: Dict, effort_level: ReasoningEffort, test_name: str, prompt: str, dataset: Dict, effort_level: ReasoningEffort, prompt: str, dataset: Dict, effort_level: ReasoningEffort, dataset: Dict, effort_level: ReasoningEffort, effort_level: ReasoningEffort) -> EvaluationMetrics"},{"name":"_calculate_metrics","line":1739,"parameters":[{"name":"self","type":"self"},{"name":"response","type":"str, dataset: Dict, category: TestCategory, execution_time: float"},{"name":"dataset","type":"Dict, category: TestCategory, execution_time: float"},{"name":"category","type":"TestCategory, execution_time: float"},{"name":"execution_time","type":"float"}],"is_async":false,"return_type":"EvaluationMetrics","description":"Calculate comprehensive evaluation metrics.","signature":"_calculate_metrics(self, response: str, dataset: Dict, category: TestCategory, execution_time: float, dataset: Dict, category: TestCategory, execution_time: float, category: TestCategory, execution_time: float, execution_time: float) -> EvaluationMetrics"},{"name":"_evaluate_code_correctness","line":1796,"parameters":[{"name":"self","type":"self"},{"name":"response","type":"str, dataset: Dict"},{"name":"dataset","type":"Dict"}],"is_async":false,"return_type":"float","description":"Evaluate functional correctness of generated code.","signature":"_evaluate_code_correctness(self, response: str, dataset: Dict, dataset: Dict) -> float"},{"name":"_evaluate_code_quality","line":1826,"parameters":[{"name":"self","type":"self"},{"name":"response","type":"str"}],"is_async":false,"return_type":"float","description":"Evaluate code quality metrics.","signature":"_evaluate_code_quality(self, response: str) -> float"},{"name":"_evaluate_reasoning_quality","line":1855,"parameters":[{"name":"self","type":"self"},{"name":"response","type":"str"}],"is_async":false,"return_type":"float","description":"Evaluate reasoning quality.","signature":"_evaluate_reasoning_quality(self, response: str) -> float"},{"name":"_evaluate_creativity","line":1882,"parameters":[{"name":"self","type":"self"},{"name":"response","type":"str"}],"is_async":false,"return_type":"float","description":"Evaluate creativity and originality.","signature":"_evaluate_creativity(self, response: str) -> float"},{"name":"_evaluate_structure_quality","line":1909,"parameters":[{"name":"self","type":"self"},{"name":"response","type":"str"}],"is_async":false,"return_type":"float","description":"Evaluate structure and organization.","signature":"_evaluate_structure_quality(self, response: str) -> float"},{"name":"_evaluate_completeness","line":1938,"parameters":[{"name":"self","type":"self"},{"name":"response","type":"str, dataset: Dict"},{"name":"dataset","type":"Dict"}],"is_async":false,"return_type":"float","description":"Evaluate completeness of response.","signature":"_evaluate_completeness(self, response: str, dataset: Dict, dataset: Dict) -> float"},{"name":"_evaluate_accuracy","line":1965,"parameters":[{"name":"self","type":"self"},{"name":"response","type":"str, dataset: Dict"},{"name":"dataset","type":"Dict"}],"is_async":false,"return_type":"float","description":"Evaluate accuracy for reasoning tasks.","signature":"_evaluate_accuracy(self, response: str, dataset: Dict, dataset: Dict) -> float"},{"name":"_evaluate_json_validity","line":1985,"parameters":[{"name":"self","type":"self"},{"name":"response","type":"str"}],"is_async":false,"return_type":"float","description":"Evaluate JSON validity for structured output.","signature":"_evaluate_json_validity(self, response: str) -> float"},{"name":"_evaluate_functional_correctness","line":2002,"parameters":[{"name":"self","type":"self"},{"name":"response","type":"str, dataset: Dict"},{"name":"dataset","type":"Dict"}],"is_async":false,"return_type":"float","description":"Evaluate functional correctness for creative tasks.","signature":"_evaluate_functional_correctness(self, response: str, dataset: Dict, dataset: Dict) -> float"}],"properties":[],"description":"Contains methods for evaluating models against specified criteria and metrics."},{"name":"ComprehensiveTestRunner","line":2035,"inherits_from":[],"methods":[{"name":"__init__","line":2038,"parameters":[{"name":"self","type":"self"}],"is_async":false,"signature":"__init__(self)"},{"name":"run_comprehensive_tests","line":2043,"parameters":[{"name":"self","type":"self"}],"is_async":true,"return_type":"Dict[str, Any]","description":"Run all tests across all model pairs and categories.","signature":"async run_comprehensive_tests(self) -> Dict[str, Any]"},{"name":"_test_gpt5_reasoning_efforts","line":2072,"parameters":[{"name":"self","type":"self"}],"is_async":true,"return_type":"Dict[str, Any]","description":"Test GPT-5 with different reasoning effort levels on coding tasks.","signature":"async _test_gpt5_reasoning_efforts(self) -> Dict[str, Any]"},{"name":"_test_category_with_reasoning_effort","line":2120,"parameters":[{"name":"self","type":"self"},{"name":"model","type":"str, category: TestCategory, effort_level: ReasoningEffort"},{"name":"category","type":"TestCategory, effort_level: ReasoningEffort"},{"name":"effort_level","type":"ReasoningEffort"}],"is_async":true,"return_type":"Dict[str, Any]","description":"Test a specific category with a specific reasoning effort level.","signature":"async _test_category_with_reasoning_effort(self, model: str, category: TestCategory, effort_level: ReasoningEffort, category: TestCategory, effort_level: ReasoningEffort, effort_level: ReasoningEffort) -> Dict[str, Any]"},{"name":"_calculate_reasoning_effort_summary","line":2151,"parameters":[{"name":"self","type":"self"},{"name":"categories","type":"Dict[str, Any]"}],"is_async":false,"return_type":"Dict[str, Any]","description":"Calculate summary statistics for a reasoning effort level.","signature":"_calculate_reasoning_effort_summary(self, categories: Dict[str, Any]) -> Dict[str, Any]"},{"name":"_analyze_coding_performance_across_efforts","line":2185,"parameters":[{"name":"self","type":"self"},{"name":"reasoning_efforts","type":"Dict[str, Any]"}],"is_async":false,"return_type":"Dict[str, Any]","description":"Analyze how coding performance varies across reasoning effort levels.","signature":"_analyze_coding_performance_across_efforts(self, reasoning_efforts: Dict[str, Any]) -> Dict[str, Any]"},{"name":"_test_model_pair","line":2237,"parameters":[{"name":"self","type":"self"},{"name":"gpt41_model","type":"str, gpt5_model: str"},{"name":"gpt5_model","type":"str"}],"is_async":true,"return_type":"Dict[str, Any]","description":"Test a pair of models across all categories.","signature":"async _test_model_pair(self, gpt41_model: str, gpt5_model: str, gpt5_model: str) -> Dict[str, Any]"},{"name":"_test_category","line":2252,"parameters":[{"name":"self","type":"self"},{"name":"gpt41_model","type":"str, gpt5_model: str, category: TestCategory"},{"name":"gpt5_model","type":"str, category: TestCategory"},{"name":"category","type":"TestCategory"}],"is_async":true,"return_type":"Dict[str, Any]","description":"Test a specific category for both models.","signature":"async _test_category(self, gpt41_model: str, gpt5_model: str, category: TestCategory, gpt5_model: str, category: TestCategory, category: TestCategory) -> Dict[str, Any]"},{"name":"_compare_metrics","line":2292,"parameters":[{"name":"self","type":"self"},{"name":"gpt41_metrics","type":"EvaluationMetrics, gpt5_metrics: EvaluationMetrics"},{"name":"gpt5_metrics","type":"EvaluationMetrics"}],"is_async":false,"return_type":"Dict[str, Any]","description":"Compare metrics between two models.","signature":"_compare_metrics(self, gpt41_metrics: EvaluationMetrics, gpt5_metrics: EvaluationMetrics, gpt5_metrics: EvaluationMetrics) -> Dict[str, Any]"},{"name":"_calculate_overall_improvement","line":2307,"parameters":[{"name":"self","type":"self"},{"name":"gpt41_metrics","type":"EvaluationMetrics, gpt5_metrics: EvaluationMetrics"},{"name":"gpt5_metrics","type":"EvaluationMetrics"}],"is_async":false,"return_type":"float","description":"Calculate overall improvement score.","signature":"_calculate_overall_improvement(self, gpt41_metrics: EvaluationMetrics, gpt5_metrics: EvaluationMetrics, gpt5_metrics: EvaluationMetrics) -> float"},{"name":"_metrics_to_dict","line":2322,"parameters":[{"name":"self","type":"self"},{"name":"metrics","type":"EvaluationMetrics"}],"is_async":false,"return_type":"Dict[str, Any]","description":"Convert metrics to dictionary for JSON serialization.","signature":"_metrics_to_dict(self, metrics: EvaluationMetrics) -> Dict[str, Any]"},{"name":"_calculate_category_summary","line":2337,"parameters":[{"name":"self","type":"self"},{"name":"tests","type":"Dict[str, Any]"}],"is_async":false,"return_type":"Dict[str, Any]","description":"Calculate summary statistics for a category.","signature":"_calculate_category_summary(self, tests: Dict[str, Any]) -> Dict[str, Any]"},{"name":"_generate_comprehensive_report","line":2351,"parameters":[{"name":"self","type":"self"},{"name":"total_time","type":"float"}],"is_async":false,"return_type":"Dict[str, Any]","description":"Generate comprehensive comparison report.","signature":"_generate_comprehensive_report(self, total_time: float) -> Dict[str, Any]"},{"name":"_save_results","line":2398,"parameters":[{"name":"self","type":"self"},{"name":"report","type":"Dict[str, Any]"}],"is_async":false,"return_type":"None","description":"Save comprehensive results to files.","signature":"_save_results(self, report: Dict[str, Any]) -> None"},{"name":"_generate_markdown_report","line":2423,"parameters":[{"name":"self","type":"self"},{"name":"report","type":"Dict[str, Any], f"},{"name":"f","type":"unknown"}],"is_async":false,"return_type":"None","description":"Generate comprehensive markdown report.","signature":"_generate_markdown_report(self, report: Dict[str, Any], f, f) -> None"},{"name":"_generate_executive_summary","line":2493,"parameters":[{"name":"self","type":"self"},{"name":"report","type":"Dict[str, Any], f"},{"name":"f","type":"unknown"}],"is_async":false,"return_type":"None","description":"Generate executive summary.","signature":"_generate_executive_summary(self, report: Dict[str, Any], f, f) -> None"}],"properties":[],"description":"Facilitates the execution of a comprehensive suite of tests, managing test execution and reporting."}],"imports":[{"module":"asyncio","alias":null,"line":18,"statement":"import asyncio"},{"module":"json","alias":null,"line":19,"statement":"import json"},{"module":"time","alias":null,"line":20,"statement":"import time"},{"module":"re","alias":null,"line":21,"statement":"import re"},{"module":"statistics","alias":null,"line":22,"statement":"import statistics"},{"module":"os","alias":null,"line":23,"statement":"import os"},{"module":"numpy","alias":"np","line":28,"statement":"import numpy as np"},{"module":"datetime","alias":null,"line":24,"statement":"from datetime import datetime"},{"module":"typing","alias":null,"line":25,"statement":"from typing import Any"},{"module":"typing","alias":null,"line":25,"statement":"from typing import Dict"},{"module":"typing","alias":null,"line":25,"statement":"from typing import List"},{"module":"typing","alias":null,"line":25,"statement":"from typing import Tuple"},{"module":"typing","alias":null,"line":25,"statement":"from typing import Optional"},{"module":"dataclasses","alias":null,"line":26,"statement":"from dataclasses import dataclass"},{"module":"enum","alias":null,"line":27,"statement":"from enum import Enum"}],"constants":[{"name":"MODEL_PAIRS","line":57,"value":"[]","type":"list"},{"name":"GPT5_REASONING_CONFIGS","line":64,"value":"{}","type":"dict"},{"name":"GPT41_CONFIG","line":98,"value":"{'iterations': 3, 'timeout': 300, 'max_tokens': 4000, 'temperature': 0.1, 'api_type': 'chat_completions', 'critic_enabled': True}","type":"dict"},{"name":"GPT5_CONFIG","line":107,"value":"{'iterations': 3, 'timeout': 300, 'max_tokens': 4000, 'temperature': 0.1, 'api_type': 'responses', 'reasoning_effort': 'high', 'verbosity': 'medium', 'previous_response_id': None, 'critic_enabled': True}","type":"dict"},{"name":"GPT41_OPTIMIZED_PROMPTS","line":124,"value":"{}","type":"dict"},{"name":"GPT5_OPTIMIZED_PROMPTS","line":783,"value":"{}","type":"dict"},{"name":"TEST_DATASETS","line":1325,"value":"{}","type":"dict"}]},"key_elements":[{"name":"asyncio","type":"import","line":18},{"name":"json","type":"import","line":19},{"name":"time","type":"import","line":20},{"name":"re","type":"import","line":21},{"name":"statistics","type":"import","line":22},{"name":"os","type":"import","line":23},{"name":"numpy","type":"import","line":28},{"name":"from datetime import datetime","type":"import","line":24},{"name":"from typing import Any","type":"import","line":25},{"name":"from typing import Dict","type":"import","line":25},{"name":"from typing import List","type":"import","line":25},{"name":"from typing import Tuple","type":"import","line":25},{"name":"from typing import Optional","type":"import","line":25},{"name":"from dataclasses import dataclass","type":"import","line":26},{"name":"from enum import Enum","type":"import","line":27},{"name":"TestCategory","type":"class","line":34},{"name":"ModelTier","type":"class","line":46},{"name":"ReasoningEffort","type":"class","line":51},{"name":"MODEL_PAIRS","type":"constant","line":57},{"name":"GPT5_REASONING_CONFIGS","type":"constant","line":64},{"name":"GPT41_CONFIG","type":"constant","line":98},{"name":"GPT5_CONFIG","type":"constant","line":107},{"name":"GPT41_OPTIMIZED_PROMPTS","type":"constant","line":124},{"name":"GPT5_OPTIMIZED_PROMPTS","type":"constant","line":783},{"name":"TEST_DATASETS","type":"constant","line":1325},{"name":"EvaluationMetrics","type":"class","line":1616},{"name":"ModelEvaluator","type":"class","line":1629},{"name":"ComprehensiveTestRunner","type":"class","line":2035},{"name":"main","type":"function","line":2553}],"sections":[{"name":"Imports","description":"Import statements for required modules and libraries.","line_start":18,"line_end":28},{"name":"main Function","description":"Function main implementation.","line_start":2553,"line_end":2558},{"name":"TestCategory Class","description":"Class TestCategory definition and methods.","line_start":34,"line_end":44},{"name":"ModelTier Class","description":"Class ModelTier definition and methods.","line_start":46,"line_end":56},{"name":"ReasoningEffort Class","description":"Class ReasoningEffort definition and methods.","line_start":51,"line_end":61},{"name":"EvaluationMetrics Class","description":"Class EvaluationMetrics definition and methods.","line_start":1616,"line_end":1626},{"name":"ModelEvaluator Class","description":"Class ModelEvaluator definition and methods.","line_start":1629,"line_end":2005},{"name":"ComprehensiveTestRunner Class","description":"Class ComprehensiveTestRunner definition and methods.","line_start":2035,"line_end":2496},{"name":"Constants","description":"Global constants and configuration values.","line_start":57,"line_end":1325}],"content_hash":"55d5e2bfa08c1f53e32c5f5331d3a25a"} FILE_MAP_END
...
class ComprehensiveTestRunner:
    ...
    async def _test_gpt5_reasoning_efforts(self) -> Dict[str, Any]:
        ...
        reasoning_results = {"reasoning_efforts": {}, "coding_performance_analysis": {}}
    ...
    async def _test_category_with_reasoning_effort(
        ...
        category_results = {"tests": {}, "summary": {}}
    ...
    def _analyze_coding_performance_across_efforts(
        ...
        analysis = {"performance_comparison": {}, "recommendations": {}, "insights": []}
    ...
    def _calculate_category_summary(self, tests: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for test_name, test_data in tests.items():
            improvements.append(test_data["comparison"]["overall_improvement"])
