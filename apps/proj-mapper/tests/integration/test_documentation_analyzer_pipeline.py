...
from proj_mapper.claude_code_adapter import DocumentationAnalysisStage, MarkdownAnalyzer
...
class TestDocumentationAnalyzerPipeline:
    ...
    def test_documentation_analyzer_pipeline(self, test_docs_dir):
        ...
        simple_result = next(
            r for r in analysis_results if r["file"].relative_path == "simple.md"
        )
