...
from proj_mapper.claude_code_adapter import AnalysisPipeline
...
class TestAnalysisPipeline(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.pipeline = AnalysisPipeline(
            max_workers=1
        )  # Use 1 worker for deterministic testing
        ...
        with open(self.python_file_path, "w") as f:
            f.write(
                '''"""Test module for testing analysis."""
import os
from pathlib import Path
...
"""
    ...
    def test_analyze_project(self):
        ...
        self.assertIsInstance(
            results[str(self.markdown_file_path)], DocumentationAnalysisResult
        )
    ...
    def test_analyze_project_with_filter(self):
        ...
        results = self.pipeline.analyze_project(
            self.project, file_types={FileType.PYTHON}
        )
    ...
    def test_get_related_files(self):
        ...
        self.pipeline.results = {
            ...
            "/path/to/target_module.py": CodeAnalysisResult(
                file_path="/path/to/target_module.py"
            ),
        }
    ...
    def test_get_code_references_to_file(self):
        ...
        self.assertEqual(
            references["/path/to/source.py"][0]["referencing_element"], "test_function"
        )
    ...
    def test_get_documentation_for_code(self):
        ...
        doc_element = DocumentationElement(
            ...
            location=Location(
                file_path="/path/to/readme.md", start_line=10, end_line=15
            ),
        ...
        self.assertEqual(
            references["/path/to/readme.md"][0]["doc_element"], "code_block"
        )
