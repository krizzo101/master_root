...
class SpecStoryFileWatcher(FileSystemEventHandler):
        ...
        if not pattern_list:
            ...
            if os.path.exists(config_path):
                try:
                    ...
                    print(f"⚠️ Error loading file patterns from {config_path}: {e}")
                    pattern_list = []
        if not pattern_list:
    ...
    async def _handle_file_event(self, filepath: str, event_type: str):
        ...
        try:
            ...
            print(f"⚠️ Error handling file event for {filepath}: {e}")
    ...
    async def _queue_for_processing(self, filepath: str, event_type: str):
        ...
        print(f"🔍 Queued SpecStory file: {Path(filepath).name} ({event_type})")
...
class RealTimeFileMonitor:
    ...
    async def start_monitoring(self):
        ...
        print("🚀 Starting SpecStory file monitoring...")
        print(f"📁 Watching directories: {self.watch_directories}")
        ...
        print(f"✅ File monitoring active on {len(self.observers)} directories")
    ...
    async def _initial_file_scan(self):
        ...
        print(f"📚 Found {total_found} existing SpecStory files")
