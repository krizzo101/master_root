...
async def main():
    ...
    config = {
        ...
        "context": {"max_tokens": 4000, "summarization_threshold": 3000, "compression_ratio": 0.5},
        "limits": {"memory_mb": 2048, "cpu_percent": 80, "disk_mb": 1024, "daily_tokens": 100000},
        "safety": {
        ...
        "research": {"cache_ttl_hours": 24, "max_search_results": 5, "enable_web_search": False},
        "logging": {"level": "ERROR", "file": "data/logs/demo.log"},
    }
    ...
    for i in range(1, 6):
        ...
        context = ExecutionContext(iteration=i, goal=goal, state=AgentState.EXECUTING)
