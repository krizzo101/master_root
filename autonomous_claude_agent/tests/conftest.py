...
def mock_config():
    ...
    return {
        ...
        "claude": {
            ...
            "timeout": 10,
            "retry_max": 2,
            "rate_limits": {"requests_per_minute": 60, "tokens_per_day": 10000},
        },
        "context": {"max_tokens": 1000, "summarization_threshold": 800, "compression_ratio": 0.5},
        "limits": {"memory_mb": 512, "cpu_percent": 50, "disk_mb": 100, "daily_tokens": 10000},
        "safety": {
        ...
        "research": {"cache_ttl_hours": 1, "max_search_results": 5, "enable_web_search": False},
...
def mock_resource_monitor(mock_config):
    ...
    monitor.get_current_usage = Mock(
        return_value={"cpu_percent": 25, "memory_mb": 256, "disk_mb": 50, "token_usage": 500}
    )
...
def sample_test_result():
    ...
    return {
        "context": {"iteration": 1, "goal": "test goal", "state": "executing"},
        "assessment": {
            "progress": 25,
            "bottlenecks": ["speed"],
        ...
        "plan": {"type": "sync", "prompt": "Optimize performance", "opportunities": {}},
        "execution": {"success": True, "result": {"actions": ["added_caching"]}, "plan": {}},
        "validation": {"success": True, "improvements": 1, "issues": []},
