...
async def main():
    ...
    ai_patterns = AIPatternEngine(claude_client=claude_client, ai_decision_engine=ai_decision)
    ...
    decision = await ai_decision.make_decision(
        context={
            ...
            "constraints": {"downtime": "zero", "budget": "limited", "timeline": "1 week"},
        },
    ...
    for obs in observations:
        discovered = await ai_patterns.observe_and_learn(
            observation=obs, context={"system": "production", "day": "weekday"}
        )
