...
class ContextManager:
    ...
    def add_context(self, content: str, item_type: str = 'data', 
                   importance: float = 1.0, can_compress: bool = True) -> bool:
    ...
    async def compress_context(self) -> Dict[str, Any]:
        ...
        logger.info(f"Context compression complete: {compressed_count} items, {reduction} tokens saved")
    ...
    def _compress_assistant_response(self, content: str) -> str:
        ...
        for line in lines:
            ...
            if any(keyword in line.lower() for keyword in 
                  ['result', 'error', 'success', 'failed', 'complete', 'found']):
