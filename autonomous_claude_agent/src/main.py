...
@click.option(
    "--mode", default="autonomous", type=click.Choice(["autonomous", "supervised", "debug"])
)
...
async def async_main(agent, goal, checkpoint, dashboard, shutdown_event):
    ...
    try:
        ...
        # Wait for either agent completion or shutdown
            ...
            [agent_task, shutdown_event.wait()], return_when=asyncio.FIRST_COMPLETED
        )
...
def create_default_config():
    ...
    return {
        ...
        "research": {"cache_ttl_hours": 24, "max_search_results": 10, "enable_web_search": True},
        "logging": {
            "level": "INFO",
