...
class DocumentAnalyzer:
    ...
    def _compile_patterns(self) -> Dict[str, re.Pattern]:
        ...
        return {
            ...
            "parameter": re.compile(r"(?:param|parameter|arg|argument)\s+(\w+):\s*(.+?)(?:\n|$)", re.IGNORECASE),
            "return_value": re.compile(r"(?:returns?|return value):\s*(.+?)(?:\n|$)", re.IGNORECASE),
            "warning": re.compile(r"(?:warning|caution|important|note):\s*(.+?)(?:\n|$)", re.IGNORECASE),
        ...
        **kwargs
        ...
        return DocumentAnalysis(
            ...
            metadata={
                ...
                "valid_json": "error" not in structure
            }
        )
    ...
    async def batch_analyze(
        self,
        documents: List[Tuple[Union[str, Path], Optional[DocumentType]]],
        **kwargs
        ...
        """
        tasks = [
            self.analyze(content, doc_type, **kwargs)
        ...
        for idx, result in enumerate(results):
            if isinstance(result, Exception):
                ...
                output.append(DocumentAnalysis(
