...
class MetricsExporter:
    ...
    def __init__(self, namespace: str = "autonomous_agent", port: int = 9090):
    ...
    def get_aggregated_metrics(
        self, metric_name: str, aggregation: str = "avg", duration: Optional[timedelta] = None
    ) -> Optional[float]:
    ...
    async def example():
        ...
        for i in range(10):
            ...
            exporter.increment_counter(
                "agent_tasks_total", labels={"status": "success", "agent_type": "research"}
            )
