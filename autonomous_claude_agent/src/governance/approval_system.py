...
class ApprovalSystem:
    ...
    def _init_default_policies(self) -> None:
        ...
        self.add_policy(ApprovalPolicy(
            policy_id="POL001",
    ...
    def remove_policy(self, policy_id: str) -> None:
        ...
        if policy_id in self.policies:
            ...
            if self.audit_logger:
                self.audit_logger.log_event(
                    event_type="APPROVAL_POLICY_REMOVED",
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        return {
            **self.stats,
            ...
            "policy_usage": {
                pid: count for pid, count in self.policy_usage_count.items()
            }
        }
    ...
    def export_approval_history(self, filepath: str) -> None:
        ...
        history = {
            ...
            "recent_completed": [
                r.to_dict() for r in self.completed_requests[-100:]
            ],
            "policies": [
                {
