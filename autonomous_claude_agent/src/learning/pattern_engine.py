...
class PatternEngine:
        ...
        if task and tool:
            ...
            if pattern_id in self.patterns:
                ...
                pattern.success_rate = (
                    self.pattern_stats[pattern_id]['successes'] / 
                    pattern.occurrences
                )
            else:
                pattern = Pattern(
    ...
    async def update_pattern_outcome(self, pattern_id: str, success: bool, 
    ...
    async def prune_ineffective_patterns(self, min_success_rate: float = 0.3, 
