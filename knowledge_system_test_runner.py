...
class KnowledgeSystemTestRunner:
    ...
    async def test_knowledge_store(self) -> TestResult:
        ...
        try:
            ...
            for i, test_case in enumerate(test_cases):
                ...
                self.test_data[f"stored_{test_case['type']}"] = result_data[
                    "knowledge_id"
                ]
    ...
    async def test_knowledge_query(self) -> TestResult:
        ...
        try:
            query_tests = [
                {"type": "search", "text": "python", "expected_success": True},
                {
                    "type": "by_type",
                ...
                {"type": "recent", "limit": 5, "expected_success": True},
            ]
        ...
        try:
            ...
            failure_result = {
                ...
                "params": {
                    ...
                    "failure_reason": "Test failure scenario",
                },
            }
    ...
    async def test_knowledge_relationships(self) -> TestResult:
        ...
        try:
            ...
            return TestResult(
                ...
                success=result_data["success"],
                duration=duration,
                metrics={"relationship_created": result_data["success"]},
            )
        except Exception as e:
            duration = time.time() - start_time
            return TestResult(
            ...
            for test in error_tests:
                ...
                try:
                    ...
                    if test["name"] == "Invalid Knowledge Type":
                        result_data = {
                            "success": False,
                            "error": "Invalid knowledge type: INVALID_TYPE",
                        }
            ...
            return TestResult(
                ...
                metrics={
                    ...
                    "graceful_failures": sum(
                        1 for r in error_results if r["handled_gracefully"]
                    ),
                },
        ...
        try:
            ...
            return TestResult(
                ...
                metrics={
                    ...
                    "successful_edge_tests": sum(
                        1 for r in edge_results if r["success"]
                    ),
                },
            ...
            duration = time.time() - start_time
            return TestResult(
                test_name="Edge Cases", success=False, duration=duration, error=str(e)
            )
    ...
    def print_report(self, report: TestReport):
        ...
        # Save report to file
        report_file = (
            f"knowledge_test_report_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
        )
