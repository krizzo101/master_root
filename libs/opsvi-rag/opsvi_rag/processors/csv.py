...
class CSVProcessorConfig(ProcessorConfig):
    ...
    processor_type: ProcessorType = Field(
        default=ProcessorType.CSV, description="Processor type"
    )
...
class CSVProcessor(BaseProcessor):
    ...
    def __init__(self, config: CSVProcessorConfig):
    ...
    def can_process(self, file_path: Path) -> bool:
        ...
        return file_path.suffix.lower() in [".csv"]
