...
from opsvi_auto_forge.core.prompting.models import PromptPack
from opsvi_auto_forge.core.prompting.pga import PromptGenerationAgent
from opsvi_auto_forge.core.decision_kernel.interfaces import IPromptGateway
        ...
        try:
            ...
            if hasattr(response, "output_text"):
                try:
                    ...
                    # Verify the response
                    from opsvi_auto_forge.core.decision_kernel.verification import (
                        verify_output,
                    )
