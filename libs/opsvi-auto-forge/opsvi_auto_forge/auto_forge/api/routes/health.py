...
class HealthChecker:
    ...
    async def check_system_health(self) -> Dict[str, Any]:
        ...
        all_healthy = (
            ...
            and dependencies_health["status"] == "healthy"
            and services_health["status"] == "healthy"
        )
    ...
    async def _check_dependencies(self) -> Dict[str, Any]:
        ...
        dependencies = {"status": "healthy", "neo4j": {}, "redis": {}, "celery": {}}
        ...
        try:
            ...
            dependencies["neo4j"] = {
                ...
                "connection_pool_size": getattr(
                    self.neo4j_client, "pool_size", "unknown"
                ),
                "active_connections": getattr(
                    self.neo4j_client, "active_connections", "unknown"
                ),
            }
            ...
            dependencies["neo4j"] = {"status": "unhealthy", "error": str(e)}
        ...
        try:
            ...
            dependencies["celery"] = {"status": "unhealthy", "error": str(e)}
            dependencies["status"] = "unhealthy"
    ...
    async def _check_services(self) -> Dict[str, Any]:
        ...
        services = {"status": "healthy", "api": {}, "task_execution": {}, "memory": {}}
        ...
        try:
            ...
            services["task_execution"] = {"status": "unhealthy", "error": str(e)}
            services["status"] = "unhealthy"
