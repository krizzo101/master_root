...
try:
    from auto_forge.core.prompting.models import ContextBundle
except ImportError:
...
class ChromaClient:
    ...
    def store_context_bundle(
        self, bundle: ContextBundle, metadata: dict[str, Any] | None = None
    ) -> str:
    ...
    def search_context_bundles(
        self, query: str, top_k: int = 8, filters: dict[str, Any] | None = None
    ...
    def get_context_bundle(self, doc_id: str) -> ContextBundle | None:
