...
class InterfaceAgent(BaseAgent):
    ...
    def _analyze_intent(self, content: str) -> str:
        ...
        if any(word in content_lower for word in ["help", "assist", "how"]):
            ...
            word in content_lower for word in ["configure", "setting", "preference"]
        ):
    ...
    def _handle_configuration(
        self, message: Message, interaction: Interaction
    ) -> Dict[str, Any]:
    ...
    def _send_message(self, task: Dict[str, Any]) -> Dict[str, Any]:
        ...
        logger.info(
            "message_sent", recipient=recipient, type=msg_type, message_id=message.id
        )

        return {"message_id": message.id, "sent": True}
    ...
    def _receive_message(self, task: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"messages": [msg.to_dict() for msg in messages], "count": len(messages)}
    ...
    def _send_notification(self, task: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"notification_id": notification.id, "sent": True}
    ...
    def set_user_preferences(self, user_id: str, preferences: Dict[str, Any]):
        ...
        if "response_format" in preferences:
            prefs.response_format = ResponseFormat[
                preferences["response_format"].upper()
            ]
