...
class OrchestratorAgent(BaseAgent):
    ...
    def _orchestrate_workflow(self, task: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"result": result, "workflow_id": workflow.id}
            ...
            for agent_id in agents:
                if agent_id in self.agent_registry:
                    ...
                    future = self.executor.submit(
                        self._coordinate_single_agent, agent_id
                    )
    ...
    def _delegate_task(self, task: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"delegated_to": agent_id, "result": result}
    ...
    def _create_workflow(self, task: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"workflow": workflow.to_dict(), "workflow_id": workflow.id}
    ...
    def _execute_workflow(self, task: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"result": result.to_dict(), "workflow_id": workflow_id}
    ...
    def _register_agent(self, task: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if isinstance(agent, BaseAgent):
            ...
            return {"registered": True, "agent_id": agent_id, "role": role}
    ...
    def _execute_workflow_internal(self, workflow: Workflow) -> OrchestrationResult:
        ...
        result = OrchestrationResult(workflow_id=workflow.id, success=True)
        ...
        result.metrics["tasks_completed"] = sum(
            1 for t in workflow.tasks if t.status == "completed"
        )
        result.metrics["tasks_failed"] = sum(
