...
class PlannerAgent(BaseAgent):
    ...
    def __init__(self, config: Optional[AgentConfig] = None):
        ...
        super().__init__(config or AgentConfig(
            ...
            capabilities=["planning", "decomposition", "scheduling", "optimization"],
            max_retries=3,
            timeout=60
        ))
    ...
    def _build_dependencies(self, tasks: List[Task], context: Dict[str, Any]) -> List[Task]:
    ...
    def _analyze_complexity(self, goal: str) -> str:
        ...
        complex_keywords = ["system", "architecture", "integrate", "optimize", "refactor"]
