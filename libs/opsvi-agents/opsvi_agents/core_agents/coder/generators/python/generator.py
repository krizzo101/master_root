...
class PythonGenerator:
    ...
    def generate(self, description: str, analysis: AnalysisResult, style: Dict[str, Any] = None) -> str:
    ...
    def _generate_singleton(self, description: str, analysis: AnalysisResult, style: Dict[str, Any]) -> str:
    ...
    def _generate_factory(self, description: str, analysis: AnalysisResult, style: Dict[str, Any]) -> str:
    ...
    def _generate_crud_operations(self, description: str, analysis: AnalysisResult, style: Dict[str, Any]) -> str:
...
class {entity.capitalize()}Manager:
    ...
    def _generate_validator(self, description: str, analysis: AnalysisResult, style: Dict[str, Any]) -> str:
...
class {entity.capitalize()}Validator:
    ...
    def _generate_default(self, description: str, analysis: AnalysisResult, style: Dict[str, Any]) -> str:
