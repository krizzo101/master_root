...
class CoderAgent(BaseAgent):
    ...
    {{methods}}'''
        ...
        self.templates["function"] = '''def {name}({{params}}) -> {{return_type}}:
    """{{docstring}}"""
    {{body}}'''
        
        self.templates["test"] = '''def test_{name}():
    """Test {{description}}."""
    # Arrange
    {{arrange}}
...
module.exports = {{ processData }};'''
    ...
    def _refactor_code(self, task: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if "readability" in goals:
            refactored, readability_changes = self._improve_readability(refactored, lang_enum)
    ...
    def _fix_code(self, task: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if "SyntaxError" in error:
            ...
            # Simple fixes
            fixed = fixed.replace("=", "==") if "if " in fixed and "=" in fixed else fixed
    ...
    def _improve_readability(self, code: str, language: Language) -> Tuple[str, List[str]]:
    ...
    def _improve_performance(self, code: str, language: Language) -> Tuple[str, List[str]]:
    ...
    def _improve_structure(self, code: str, language: Language) -> Tuple[str, List[str]]:
