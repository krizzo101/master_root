...
from ..core import BaseAgent, AgentConfig, AgentCapability
...
class ReActAgent(BaseAgent):
    ...
    def _execute(self, prompt: str, **kwargs) -> Any:
        ...
        for i in range(max_iterations):
            ...
            if self.config.checkpoint_enabled:
                self._create_checkpoint(f"iteration_{i+1}", {
                    "thoughts": thoughts,
                    "actions": actions,
    ...
    def _think(
        ...
        if not thoughts:
            ...
            return f"Based on the last observation, I should continue working on: {prompt}"
