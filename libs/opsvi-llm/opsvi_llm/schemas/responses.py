...
class ChatMessage(BaseModel):
    ...
    name: str | None = Field(
        default=None, description="Message name (for function messages)"
    )
...
class FunctionParameter(BaseModel):
    ...
    items: dict[str, Any] | None = Field(default=None, description="Array item schema")
...
class LLMResponse(BaseModel):
    ...
    finish_reason: str | None = Field(
        default=None, description="Reason generation finished"
    )
...
class StreamChunk(BaseModel):
    ...
    finish_reason: str | None = Field(
        default=None, description="Finish reason if stream ended"
    )
    function_call: FunctionCall | None = Field(
        default=None, description="Function call chunk"
    )
...
class ModerationResult(BaseModel):
    ...
    category_scores: dict[str, float] = Field(
        ..., description="Category confidence scores"
    )
