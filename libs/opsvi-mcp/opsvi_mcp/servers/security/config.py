...
class SecurityConfig:
    ...
    report_directory: Path = field(
        default_factory=lambda: Path("/tmp/security_reports")
    )
    ...
    def from_env(cls) -> "SecurityConfig":
        ...
        return cls(
            ...
            enable_semgrep=os.getenv("SECURITY_ENABLE_SEMGREP", "true").lower()
            == "true",
            enable_safety=os.getenv("SECURITY_ENABLE_SAFETY", "true").lower() == "true",
            enable_secret_detection=os.getenv("SECURITY_ENABLE_SECRETS", "true").lower()
            == "true",
            ...
            parallel_scans=os.getenv("SECURITY_PARALLEL_SCANS", "true").lower()
            == "true",
