...
class GeminiConfig:
    ...
    working_directory: str = field(
        default_factory=lambda: os.environ.get('GEMINI_WORKING_DIR', '/home/opsvi/master_root')
    )
    
    # MCP Settings
    enable_mcp_servers: bool = True
    mcp_servers_config: Optional[str] = field(
        default_factory=lambda: os.environ.get('GEMINI_MCP_CONFIG', 'gemini-settings.json')
    )
