    ...
    async def _execute_task(self, request: GeminiRequest) -> GeminiResponse:
        ...
        try:
            ...
            if request.enable_file_ops or request.enable_shell:
                cmd.extend(["--approval-mode", "yolo"])  # Auto-approve for programmatic use
            ...
            response.cost_estimate = response.tokens_used * 0.000001  # Placeholder pricing
