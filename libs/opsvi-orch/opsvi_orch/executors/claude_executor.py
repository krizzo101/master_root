...
class ClaudeJobExecutor:
    ...
    async def execute_claude_job(
        ...
        try:
            ...
            self.metrics.average_time_ms = self.metrics.total_time_ms / self.metrics.total_spawned
            ...
            logger.info(f"Claude job {job_id} completed: success={success}, time={execution_time:.0f}ms")
...
class ClaudeBatchExecutor:
    ...
    def __init__(
        self,
        job_executor: Optional[ClaudeJobExecutor] = None,
    ...
    def create_claude_sends(
        ...
        for i, task in enumerate(tasks):
            ...
            send = (SendBuilder("claude_executor")
                    .with_task(task)
