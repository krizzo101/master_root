...
class JobManager:
    ...
    def __init__(
        ...
        self.recursive_pattern = RecursiveOrchestrationPattern(
    ...
    async def execute_batch_async(
        ...
        logger.info(f"Starting batch execution: {len(tasks)} tasks, batch_id={batch_id}")
