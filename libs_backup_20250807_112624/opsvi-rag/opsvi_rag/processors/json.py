...
class JSONProcessorConfig(ProcessorConfig):
    """Configuration for json processor."""

    processor_type: ProcessorType = Field(
        default=ProcessorType.JSON, description="Processor type"
    )
...
class JSONProcessor(BaseProcessor):
    ...
    def __init__(self, config: JSONProcessorConfig):
