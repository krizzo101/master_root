"""Async Postgres provider for opsvi-security using SQLAlchemy 2.x."""
...
from opsvi_security.providers.base import DataProvider  # type: ignore
...
class PostgresProvider(DataProvider):
    def __init__(self, dsn: Optional[str] = None) -> None:
        super().__init__()
        self.dsn = dsn or _env("DATABASE_URL") or _env("OPSVI_OPSVI_SECURITY__DATABASE_URL")
        if not self.dsn:
