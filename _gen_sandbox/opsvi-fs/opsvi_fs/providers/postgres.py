"""Async Postgres provider for opsvi-fs using SQLAlchemy 2.x."""
...
from opsvi_fs.providers.base import DataProvider  # type: ignore
...
class PostgresProvider(DataProvider):
    def __init__(self, dsn: Optional[str] = None) -> None:
        super().__init__()
        self.dsn = dsn or _env("DATABASE_URL") or _env("OPSVI_OPSVI_FS__DATABASE_URL")
        if not self.dsn:
